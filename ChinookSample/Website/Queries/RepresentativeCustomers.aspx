...
<asp:Content ID="Content1" ContentPlaceHolderID="MainContent" Runat="Server">
    ...
    <br /><br />
    <asp:GridView ID="WebCustomersList" runat="server" AutoGenerateColumns="False" DataSourceID="WebCustomersODS" AllowPaging="True">
        <Columns>
    ...
    <asp:ObjectDataSource ID="WebCustomersODS" runat="server" OldValuesParameterFormatString="original_{0}" 
        SelectMethod="RepresentativeCustomers_Get" TypeName="ChinookSystem.BLL.CustomerController"></asp:ObjectDataSource>
</asp:Content>
